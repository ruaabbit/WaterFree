...
class AESCoder {
  final key = encrypt_lib.Key.fromBase64('3n4DdO47LWH2Co/WfpbdyA==');
...
void waterStart(cardNum, machineNum) {
  ...
  final encrypted = aes.encrypt(data);
...
void quickStart(String machineID) {
  if (Storage.cardNum != null) {
    waterStart(Storage.cardNum, machineID);
  }
}

void quickStop(String machineID) {
  if (Storage.cardNum != null) {
    waterStop(Storage.cardNum, machineID);
  }
}
